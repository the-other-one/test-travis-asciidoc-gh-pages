...
- link:javadoc/org/beryx/textio/InputReader.html#withInputMasking-boolean-.html[input masking] - useful when reading sensitive data such as passwords.
...
- link:javadoc/org/beryx/textio/InputReader.html#withPossibleValues-java.util.List-.html[possible values] - necessary if the value to be read must be chosen from a list of allowed values.
- link:javadoc/org/beryx/textio/InputReader.html#withErrorMessageProvider-org.beryx.textio.InputReader.ErrorMessageProvider-.html[error messages] - used to provide custom error messages.
- link:javadoc/org/beryx/textio/InputReader.html#withPropertyName-java.lang.String-.html[property name] - if configured, the name of the property to be read will appear in error messages.
